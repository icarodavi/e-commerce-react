...
const imageProducts = (images: any[]) => images.map((image: any, index: number) => ({
    src: image,
    id: index,
}));
...
export function ProductById() {
    ...
    const { contextAddItemToCart } = useContextSelector(
        ShopContext,
        (context) => context,
    );
    return (
                    ...
                    <div className="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
                        ...
                        >
                            ...
                            <Tab.Panels className="aspect-w-1 aspect-h-1 w-full">
                                {data
                                    && imageProducts(data.images).map((image) => (
                        ...
                        <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
                            ...
                            <div className="mt-3">
                                ...
                                <p className="text-3xl tracking-tight text-gray-900">
                                    {data && priceFormatter.format(data.price)}
                                </p>
                            </div>
                                ...
                                <div className="mt-10 flex">
                                    <button
                                        ...
                                        onClick={(event: any) => {
                                            ...
                                            toast.success(
                                                `${data.title} was added to the cart`,
                                            );
                                        }}
                                    >
                                        Add to cart
